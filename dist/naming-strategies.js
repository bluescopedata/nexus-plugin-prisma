...
exports.defaultArgsNamingStrategy = {
    whereInput(typeName, fieldName) {
        return `${(0, utils_1.upperFirst)(typeName)}${(0, utils_1.upperFirst)(fieldName)}WhereInput`;
    },
    orderByInput(typeName, fieldName) {
        return `${(0, utils_1.upperFirst)(typeName)}${(0, utils_1.upperFirst)(fieldName)}OrderByInput`;
    },
    relationFilterInput(typeName, fieldName) {
        return `${(0, utils_1.upperFirst)(typeName)}${(0, utils_1.upperFirst)(fieldName)}Filter`;
    },
};
exports.defaultFieldNamingStrategy = {
    findUnique: (_, modelName) => (0, camelcase_1.default)(modelName),
    findMany: (_, modelName) => (0, camelcase_1.default)((0, pluralize_1.default)(modelName)),
