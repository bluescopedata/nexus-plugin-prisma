...
const buildField = (mapping, operation) => {
    ...
    return {
        ...
        model: mapping.model,
        prismaClientAccessor: (0, utils_1.lowerFirst)(mapping.model),
    };
};
...
const getCrudMappedFields = (typeName, dmmf, namingStrategy = naming_strategies_1.defaultFieldNamingStrategy) => {
    const mappedFields = (0, utils_1.flatMap)(dmmf.operations, (m) => CRUD_MAPPED_FIELDS[typeName](m)).filter((mappedField) => mappedField !== null);
