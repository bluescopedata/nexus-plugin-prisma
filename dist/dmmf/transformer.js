...
const getTransformedDmmf = (prismaClientPackagePath, options) => new DmmfDocument_1.DmmfDocument(transform((0, utils_1.getPrismaClientDmmf)(prismaClientPackagePath), options));
...
function transformDatamodel(datamodel) {
    return {
        ...
        models: datamodel.models.map((model) => (Object.assign(Object.assign({}, model), { fields: model.fields.map((field) => (Object.assign(Object.assign({}, field), { kind: field.kind === 'object' ? 'relation' : field.kind }))) }))), // TODO: Remove this once @prisma/client/runtime:DMMF contains the `uniqueFields` typed
    };
}
...
function transformOutputType(type, options) {
    return Object.assign(Object.assign({}, type), { fields: type.fields.map((field) => {
            ...
            return {
                ...
                args,
                outputType: {
                    type: (0, helpers_1.getTypeName)(field.outputType.type),
...
function transformArg(arg, atomicOperations) {
    ...
    return {
        name: arg.name,
        inputType: {
            type: (0, helpers_1.getTypeName)(inputType.type),
...
function argTypeUnionToArgType(argTypeContexts, atomicOperations) {
    ...
    const filteredArgTypeContexts = atomicOperations === false
        ? argTypeContexts.filter((argTypeCtx) => !(0, helpers_1.getTypeName)(argTypeCtx.type).endsWith('OperationsInput'))
        : argTypeContexts;
    const result = 
    ...
    (_c = (_b = (_a = filteredArgTypeContexts.find((argTypeCtx) => isInputObjectType(argTypeCtx) &&
        argTypeCtx.isList &&
        (0, helpers_1.getTypeName)(argTypeCtx.type).endsWith('WhereInput'))) !== null && _a !== void 0 ? _a : 
    // Same here
    filteredArgTypeContexts.find((argTypeCtx) => isInputObjectType(argTypeCtx) && (0, helpers_1.getTypeName)(argTypeCtx.type).endsWith('WhereInput'))) !== null && _b !== void 0 ? _b : 
    // [AnyType]
