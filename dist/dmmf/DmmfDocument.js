...
class DmmfDocument {
    constructor({ datamodel, schema, operations }) {
        ...
        // Indices
        this.modelsIndex = (0, utils_1.indexBy)(datamodel.models, 'name');
        this.enumsIndex = (0, utils_1.indexBy)(schema.enums, 'name');
        this.inputTypesIndex = (0, utils_1.indexBy)(schema.inputTypes, 'name');
        this.outputTypesIndex = (0, utils_1.indexBy)(schema.outputTypes, 'name');
        this.mappingsIndex = (0, utils_1.indexBy)(operations, 'model');
...
function indexInputTypeWithFields(inputTypes) {
    ...
    for (const inputType of inputTypes) {
        const indexedFields = (0, utils_1.indexBy)(inputType.fields, 'name');
