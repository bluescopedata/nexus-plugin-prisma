...
function doGenerate(sync, options) {
    ...
    const dmmf = (0, transformer_1.getTransformedDmmf)(options.prismaClientPath);
    ...
    if (sync) {
        (0, utils_1.hardWriteFileSync)(options.typegenPath, tsDeclaration);
    }
    else {
        return (0, utils_1.hardWriteFile)(options.typegenPath, tsDeclaration);
    }
}
...
function render(params) {
    var _a;
    return `\
import * as Typegen from '${(_a = params.nexusPrismaImportId) !== null && _a !== void 0 ? _a : '@bluescopedata/nexus-plugin-prisma/typegen'}'
...
function renderNexusPrismaInputs(dmmf) {
    const queriesFields = (0, mapping_1.getCrudMappedFields)('Query', dmmf)
