...
class Publisher {
    ...
    inputType(customArg) {
        ...
        if (this.isPublished(typeName)) {
            ...
            return Nexus.arg({
                type: (0, exports.getNexusTypesCompositionForInput)(customArg.arg.inputType).reduceRight(utils_1.apply, customArg.type.name),
            });
        }
        ...
        return Nexus.objectType({
            ...
            definition: (t) => {
                for (const field of dmmfObject.fields) {
                    ...
                    t.field(field.name, {
                        type: (0, exports.getNexusTypesCompositionForOutput)(field.outputType).reduceRight(utils_1.apply, field.outputType.type),
                    });
                }
            },
        });
        ...
        return Nexus.inputObjectType({
            ...
            definition: (t) => {
                inputType.fields.forEach((field) => {
                    ...
                    t.field(field.name, {
                        type: (0, exports.getNexusTypesCompositionForInput)(field.inputType).reduceRight(utils_1.apply, fieldType),
                    });
                });
            },
        });
