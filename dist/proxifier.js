...
function proxifyPublishers(publishers, typeName, stage, onUnknownFieldName) {
    ...
    return new Proxy(publishers, {
        get(target, key) {
            ...
            (0, hooks_1.raiseErrorOrTriggerHook)(onUnknownFieldName, {
                unknownFieldName,
                typeName,
...
If this is intentional, pass the mapped Prisma model name as parameter like so \`t.model('<PrismaModelName>').<FieldName>()\``;
        (0, hooks_1.raiseErrorOrTriggerHook)(onUnknownPrismaModelName, { unknownPrismaModelName: modelName, error: new Error() }, message, stage);
        /**
