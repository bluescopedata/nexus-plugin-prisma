...
class SchemaBuilder {
    constructor(options) {
        ...
        this.dmmf =
            options.dmmf ||
                (0, dmmf_1.getTransformedDmmf)(config.inputs.prismaClient, {
        ...
        this.getPrismaClient = (ctx) => {
            ...
            (0, utils_1.assertPrismaClientInContext)(prismaClient);
            return prismaClient;
        };
    ...
    buildCRUD() {
        return Nexus.dynamicOutputProperty({
            ...
            factory: ({ typeDef: t, typeName, stage }) => {
                ...
                const publishers = (0, mapping_1.getCrudMappedFields)(typeName, this.dmmf).reduce((crud, mappedField) => {
                    const fieldPublisher = (givenConfig) => {
                        ...
                        const schemaArgsIndex = (0, utils_1.indexBy)(mappedField.field.args, 'name');
                        const originalResolve = (_root, args, ctx, info) => __awaiter(this, void 0, void 0, function* () {
                            ...
                            args = (0, null_1.transformNullsToUndefined)(args, schemaArgsIndex, this.dmmf);
                            if (typeName === 'Mutation' &&
                                (!(0, utils_1.isEmptyObject)(publisherConfig.locallyComputedInputs) ||
                                    !(0, utils_1.isEmptyObject)(this.globallyComputedInputs))) {
                                args = yield (0, dmmf_1.addComputedInputs)({
                                    inputType,
                                    dmmf: this.dmmf,
                                    params: {
                                        info,
                        ...
                        const fieldConfig = this.buildFieldConfig({
                            ...
                            resolve: (root, args, ctx, info) => {
                                return (givenConfig === null || givenConfig === void 0 ? void 0 : givenConfig.resolve)
                ...
                return (0, proxifier_1.proxifyPublishers)(publishers, typeName, stage, this.options.onUnknownFieldName);
            },
        });
    }
    buildDisabledCRUD() {
        ...
        return Nexus.dynamicOutputProperty({
            ...
            factory: ({ typeDef, typeName, stage }) => {
                ...
                if (hasPrismaModel) {
                    ...
                    return (0, proxifier_1.proxifyModelFunction)(accessor, typeName, stage, this.options.onUnknownPrismaModelName, this.unknownFieldsByModel);
                }
            },
        });
    }
    internalBuildModel(typeName, t, stage) {
        ...
        const publishers = outputType.fields.reduce((acc, field) => {
            const fieldPublisher = (givenConfig) => {
                ...
                const schemaArgsIndex = (0, utils_1.indexBy)(field.args, 'name');
                const originalResolve = field.outputType.kind === 'object'
                    ? (root, args, ctx) => {
                        ...
                        args = (0, null_1.transformNullsToUndefined)(args, schemaArgsIndex, this.dmmf);
                        args = this.paginationStrategy.resolve(args);
                        return prismaClient[(0, utils_1.lowerFirst)(mapping.model)]
                            .findUnique({
                ...
                const fieldConfig = this.buildFieldConfig({
                    ...
                    publisherConfig,
                    typeName,
                    resolve: (givenConfig === null || givenConfig === void 0 ? void 0 : givenConfig.resolve)
                        ? (root, args, ctx, info) => {
    ...
    buildFieldConfig(config) {
        ...
        return Object.assign(Object.assign({}, additionalExternalPropsSuchAsPlugins), { args: this.buildArgsFromField(config), type: (0, publisher_1.getNexusTypesCompositionForOutput)(config.field.outputType).reduceRight(utils_1.apply, this.publisher.outputType(config.publisherConfig.type, config.field)), resolve: config.resolve });
    }
    ...
    assertOutputTypeIsDefined(typeName, fieldName, outputType, stage) {
        ...
        (0, hooks_1.raiseErrorOrTriggerHook)(this.options.onUnknownFieldType, {
    ...
    assertArgNameExists(parentTypeName, prismaOutputTypeName, fieldName, config, stage, configProperty) {
        ...
        (0, hooks_1.raiseErrorOrTriggerHook)(this.options.onUnknownArgName, {
